 ...
 var major = prompt (" what is your major " ,"Eelectrical,Civil,Architectur,Mechnaical" );
  while (major!=="Eelectrical" && major!=="Civil" && major!=="Architectur" && major!=="Mechnaical"){
     major=prompt("pleas enter one of the following Eelectrical,Civil,Architectur,Mechnaical ")
  }
  document.write('<h2>welcome '+userName+' you are in '+major+' major</h2>' )

 // var majorNum =prompt(' how many image of major you want to see ?');
 // var image = '';
 // console.log(image);

 
 // for (var i=1 ; i<=majorNum ; i++ ){
  //  if(major === "Eelectrical"){
   //  image = image + ' <img src="https://collegelearners.com/wp-content/uploads/2020/09/electrical-electronics-engineering-top-ms-specializations-jobs-salaries.jpg">'
    // } else if (major === "Civil"){
    // image = image + '<img src="https://www.sdsmt.edu/uploadedImages/Content/Academics/Degrees/_Images/DegCEEbanner.jpg">'
    // } else if (major === "Architectur"){
    //  image = image +'<img src="https://www.onlineschoolscenter.com/wp-content/uploads/2019/01/shutterstock_451541479.jpg"/>'
    // } else if (major === "Mechnaical"){
    //    image = image +'<img src="https://collegelearners.com/wp-content/uploads/2021/03/inline-mecheng.jpg"/>'
    //}  
 
  // document.write(image);

 var major = prompt (" choos othermajor you want to see it " ,"Eelectrical,Civil,Architectur,Mechnaical" ); 
 function otherMajor (major){
 if(major === "Eelectrical"){
